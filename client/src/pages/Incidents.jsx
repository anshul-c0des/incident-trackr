    ...
    <div className="bg-gray-50 h-100vh">
      <div className="max-w-4xl mx-auto mt-8 p-4 bg-white rounded-md shadow h-full flex flex-col">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-blue-600 ml-2">My Incidents</h1>
          <div className="space-x-4">
            ...
            >
              <div className="flex items-center justify-center gap-2">
                <span className='hidden lg:block md:block'>Create Incident</span>
                <CircleFadingPlus />
              </div>
            </button>
            <button
        ...
        {filteredIncidents.length === 0 && !loading && <p>No incidents found.</p>}
        ...
        <div className="flex flex-col gap-4 overflow-y-auto max-h-screen mb-2">
          ...
          >
            <div className="flex flex-col sm:w-2/3">
              ...
              <p className="text-md font-semibold text-gray-600">Reporter: {incident.reporter.name}</p>
              <p className="text-md font-semibold text-gray-600">Details: {incident.incidentDetails}</p>
